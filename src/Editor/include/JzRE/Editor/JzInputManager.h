 ...
 */
enum class JzEInputKeyboardButton {
    KEY_UNKNOWN       = -1,
    KEY_SPACE         = 32,
    KEY_APOSTROPHE    = 39,
    KEY_COMMA         = 44,
 ...
 */
enum class JzEInputKeyboardButtonState {
    KEY_UP   = 0,
    KEY_DOWN = 1
};
...
public:
     ...
     * @param key
     *
     * @return JzEInputKeyboardButtonState
     */
    JzEInputKeyboardButtonState GetKeyState(JzEInputKeyboardButton key) const;
     ...
     * @return Bool
     */
    Bool IsKeyPressed(JzEInputKeyboardButton key) const;
     ...
     * @return Bool
     */
    Bool IsKeyReleased(JzEInputKeyboardButton key) const;
