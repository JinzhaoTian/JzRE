...
/**
 * @brief File Dialog Implementation of Windows-specific
 */
class JzFileDialogWindows : public JzFileDialog {
public:
    /**
     * @brief Constructor
     *
     ...
     */
    explicit JzFileDialogWindows(const String &p_dialogTitle);

    /**
     * @brief Destructor
     */
    ~JzFileDialogWindows() override = default;
