...
std::string getQualifiedName(const std::string &display_name, const std::vector<std::string> &current_namespace)
{
    std::string name = "";
...
std::string getQualifiedName(const Cursor &cursor, const std::vector<std::string> &current_namespace)
{
