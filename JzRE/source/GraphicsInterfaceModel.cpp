...
namespace JzRE {
GraphicsInterfaceModel::GraphicsInterfaceModel(const String &path, Bool gamma) :
...
void GraphicsInterfaceModel::LoadModel(const String &path) {
...
void GraphicsInterfaceModel::ProcessNode(aiNode *node, const aiScene *scene) {
...
GraphicsInterfaceMesh GraphicsInterfaceModel::ProcessMesh(aiMesh *mesh, const aiScene *scene) {
    // data to fill
    ...
    for (U32 i = 0; i < mesh->mNumVertices; i++) {
        GraphicsInterfaceVertex vertex;
