...
/**
 * @brief File Dialog Implementation of macOS-specific
 */
class JzFileDialogMacOS : public JzFileDialog {
public:
    /**
     * @brief Constructor
     *
     ...
     */
    explicit JzFileDialogMacOS(const String &p_dialogTitle);

    /**
     * @brief Destructor
     */
    ~JzFileDialogMacOS() override = default;
