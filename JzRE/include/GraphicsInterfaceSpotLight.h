...
namespace JzRE {
class GraphicsInterfaceSpotLight : public GraphicsInterfaceLight {
public:
    GraphicsInterfaceSpotLight(const glm::vec3 &position, const glm::vec3 &direction, const glm::vec3 &color,
